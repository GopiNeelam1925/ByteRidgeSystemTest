...
import com.mindorks.framework.mvvm.ui.main.OptionClickListener;
...
public final class BindingUtils {
    ...
    @BindingAdapter({"adapter", "action","handler"})
    public static void addQuestionItems(SwipePlaceHolderView mCardsContainerView, List<QuestionCardData> mQuestionList, int mAction, OptionClickListener optionClickListener) {
            ...
            if (mQuestionList != null) {
                ...
                for (QuestionCardData question : mQuestionList) {
                    if (question != null && question.options != null) {
                        mCardsContainerView.addView(new QuestionCard(question,optionClickListener));
                    }
                }
